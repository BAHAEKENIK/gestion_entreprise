                    ...
                    @include('partials.flash-messages')
                     ...
                     <form method="GET" action="{{ route('taches.employe.index') }}" class="mb-6">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                <x-input-label for="statut_filter_employe" :value="__('Filtrer par Statut')" />
                                <select name="statut_filter_employe" id="statut_filter_employe" class="block mt-1 w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm">
                             ...
                             <table class="min-w-full divide-y divide-gray-200">
                                <thead class="bg-gray-50">
                                    <tr>
                                        ...
                                        <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase">Assignée par</th>
                                ...
                                <tbody class="bg-white divide-y divide-gray-200">
                                    ...
                                    <tr>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{{ $tache->assignePar->name }}</td>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                            ...
                                            <a href="{{ route('taches.realiser.form', $tache) }}" class="text-green-600 hover:text-green-900">Mettre à jour / Réaliser</a>
                                            @else
