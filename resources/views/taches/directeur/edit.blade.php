                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    <form method="POST" action="{{ route('taches.directeur.update', $tache) }}">
                        ...
                        <div>
                            ...
                            <x-text-input id="titre" class="block mt-1 w-full" type="text" name="titre" :value="old('titre', $tache->titre)" required autofocus />
                            <x-input-error :messages="$errors->get('titre')" class="mt-2" />
                        </div>
                        <div class="mt-4">
                            <x-input-label for="description" :value="__('Description (Optionnel)')" />
                            <textarea id="description" name="description" rows="4" class="block mt-1 w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm">{{ old('description', $tache->description) }}</textarea>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
                            <div>
                                ...
                                <x-text-input id="date_debut_prevue" class="block mt-1 w-full" type="date" name="date_debut_prevue" :value="old('date_debut_prevue', $tache->date_debut_prevue ? $tache->date_debut_prevue->format('Y-m-d') : '')" />
                            ...
                            <div>
                                ...
                                <x-text-input id="date_fin_prevue" class="block mt-1 w-full" type="date" name="date_fin_prevue" :value="old('date_fin_prevue', $tache->date_fin_prevue ? $tache->date_fin_prevue->format('Y-m-d') : '')" />
                        ...
                        <div class="mt-4">
                            ...
                            <x-text-input id="duree_estimee" class="block mt-1 w-full" type="text" name="duree_estimee" :value="old('duree_estimee', $tache->duree_estimee)" />
